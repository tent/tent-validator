...
describe "BeforeTimeParamValidator, SinceIdParamValidator, and LimitParamValidator" do
  ...
  let(:validator) { before_time_validator.merge(since_id_validator, limit_validator) }

  it "should set before_time, since_id, and limit client params" do
